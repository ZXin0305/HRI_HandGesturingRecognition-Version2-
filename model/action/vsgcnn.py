...
class VSGCNN(nn.Module):
    ...
    def forward(self, input_tensor, apply_sfmax=False):
        ...
        final_layers = self.fc(final_layers)
...
if __name__ == "__main__":
    ...
    vgcnn = VSGCNN(5, 3, 5, 0.2).to('cpu')  # n_classes, in_channels, num_groups, dropout=0.2
    image = torch.rand(1, 3, 244, 244).to('cpu')
    # print(summary.summary(vgcnn, (3, 244, 244)))
    a = vgcnn(image,apply_sfmax=True)
